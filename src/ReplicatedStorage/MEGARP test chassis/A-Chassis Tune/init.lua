...
--[[Weight and CG]]
	Tune.Weight			= 5912		-- Total weight (in pounds, under Earth's gravity)
...
Tune.FSusDamping	= 200		-- Spring Damping
...
Tune.RSusDamping	= 200		-- Spring Damping
...
--[[Engine (Avxnturador)]]
	...
	Tune.Engine 		= true		
		...
		Tune.Horsepower		= 620	-- Naturally aspirated horsepower, before adding forced induction
...
Tune.FinalDrive		= 3.42 	 --		[TRANSMISSION CALCULATIONS FOR NERDS]
