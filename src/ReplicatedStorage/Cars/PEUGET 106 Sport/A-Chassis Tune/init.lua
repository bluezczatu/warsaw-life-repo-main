...
--[[Weight and CG]]
	Tune.Weight			= 915		-- Total weight (in pounds, under Earth's gravity)
...
--[[Steering]]
	...
	Tune.LockToLock		= 5		-- Number of turns of the steering wheel lock to lock, google it for your car  --2.6
	Tune.Ackerman		= .9		-- If you don't know what it is don't touch it, ranges from .7 to 1.2

	-- Old Options
	Tune.SteerInner		= 60	-- Inner wheel steering angle (in degrees)
	...
	Tune.RSteerOuter		= 20		-- Outer rear wheel steering angle (in degrees)
	...
	Tune.RSteerD			= 500		-- Steering Dampening
...
--[[Engine (Avxnturador)]]
	...
	Tune.Engine 		= true		
		...
		Tune.PeakRPM		= 5300	-- Where horsepower reaches peak
		Tune.Redline		= 7200	-- Your engine's rev limiter
